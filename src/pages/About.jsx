    ...
    return(
        <div id="/" className="AboutBodyContainer"> 
            <div className="AboutBody"> 
                ...
                is always nice :). 
                I'm hoping to add a code section for personal projects at some point, as it would probably be good
                to showcase skills that actually pay :)))). 
                <br />
                <br />
                I built this website using React and NodeJS.
                <br />
                <br />
                Have a nice day !
            </div>
