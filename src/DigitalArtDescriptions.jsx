const Descriptions = new Map([
    ["backofdoordrawing.png",  "This was made to go outside above the front door of the flat, but I had to place it inside becasue the next door neighbours have young children haha"],
    ...
    ["castlebuilders.png", "Ilustartion for the La Dispute song 'Castle Builders', I would say that making it made me better at drawing liquids, but alas, water is still so difficult to draw for me."],
    ["castleofrats.png", "Illustration for the song 'Castle Of Rats' by The Narcisstic Cookbook, I have gone to see them live five times now so I thought it was about time I make an illustration for one of their songs. They seemed to like it though, which is always nice ,)"],
    ["CLUE_final.png", "MTG card design I made for a friend years ago"],
    ["despite_everything.png" , "This was a birthday gift to myself"],
    ["dias_architects.png", "Illustration to the song 'Dying is Absolutely Safe' by Architects, one of their softest songs, is a good final song for the album"],
    ...
    ["sundragon.png", "A very calming drawing to work on, very repetative with all the scales"],
    ["spookycommission.png", "Was commissioned to draw someones monster from their webcomic a few years ago."],
    ["to_print_tllc.png", "An illustration for the song 'The Last Lost Continent', is 12 minutes long but I only used the lyrics from the last 2 minutes. Highly recommend it"],
